...
public class Processes extends JPanel//This class creates all the components for the GUI
{
    ...
    //Draws the textfields and label neccessary for the Priority algorithm
    ...
    // Method in which we tried to draw all the textfields and labels shown on the GUI in an array...
    ...
    // These methods get the text values from either the Priority text values or
    // burst text values and also sets them if the random button was pushed
    ...
    private class handleEvent implements ActionListener
    {
        ...
        {                                           //on which button was pushed
            ...
            HashMap<Integer, Integer[]> priorityEntry = new HashMap<>();
